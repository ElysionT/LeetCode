...
public class Q1619_2 {
	...
	class SubArray{
		...
		public void insert(int value, boolean asc) {
			if(count == size) {
				if(asc && value>=end.value) {
					return;					
				}else if(!asc && value<=start.value)
